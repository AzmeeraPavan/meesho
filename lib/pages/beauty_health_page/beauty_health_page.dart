...
class ButifyPage extends StatefulWidget {
  const ButifyPage({super.key});

  @override
  State<ButifyPage> createState() => _MenPageState();
}

class _MenPageState extends State<ButifyPage> {
  ...
  Future<void> loadCategories() async {
    final List<dynamic> rawValues =
        (butify["catalogs"] as List<dynamic>?) ?? [];
